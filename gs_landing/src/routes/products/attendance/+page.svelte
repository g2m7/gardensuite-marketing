...
<div
	class="[font-synthesis:none] flex overflow-clip w-full min-h-screen flex-col bg-[#FAFAF7] antialiased text-xs/4"
>
	<!-- Navigation -->
	<nav class="flex items-center justify-between w-full py-4.5 px-6 md:px-14 border-b border-[#0000000A] bg-[#FAFAF7]/80 backdrop-blur-xl sticky top-0 z-50">
		<a href="/" class="flex items-center gap-1.5" aria-label="GardenSuite Home">
			<img src="/favicon.png" alt="" class="h-7 w-auto shrink-0" aria-hidden="true" width="28" height="28" />
		...
		<div class="hidden md:flex items-center gap-8">
			<a href="/#features" class="inline-block text-[#6B7280] font-['Inter',system-ui,sans-serif] font-medium text-sm/4.5 hover:text-black transition-colors">
				Features
			</a>
			<a href="/#clients" class="inline-block text-[#6B7280] font-['Inter',system-ui,sans-serif] font-medium text-sm/4.5 hover:text-black transition-colors">
				Clients
			</a>
			<a href="/#about" class="inline-block text-[#6B7280] font-['Inter',system-ui,sans-serif] font-medium text-sm/4.5 hover:text-black transition-colors">
				About
			</a>
		</div>
		<div class="flex items-center gap-2">
			<a href="/#contact" class="hidden md:inline-block text-[#6B7280] font-['Inter',system-ui,sans-serif] font-medium text-sm/4.5 mr-4 hover:text-black transition-colors">
				Contact
			</a>
			<a href="/#demo" class="flex items-center rounded-[100px] py-2.5 px-5 bg-[#0A0A0A] hover:scale-[1.02] active:scale-[0.98] transition-transform focus-visible:ring-2 focus-visible:ring-[#3D7D2C] focus-visible:ring-offset-2">
	...
	<!-- ============================================ -->
	<!-- STORY 01: The Arrival (Text Left, Phone Right) -->
	<!-- ============================================ -->
			...
			<div class="flex flex-1 items-center justify-center relative lg:py-16">
				<div class="animate-on-scroll" style="transition-delay: 150ms;">
					...
					<div class="flex flex-col w-[280px] md:w-[300px] h-[560px] md:h-[600px] bg-[#1A2E16] rounded-[36px] p-3.5 shadow-[0_40px_80px_rgba(26,46,22,0.3),0_0_0_1px_rgba(61,125,44,0.2)]">
						...
						<!-- Viewfinder -->
						<div class="flex flex-1 flex-col items-center justify-center bg-[#243D1E] rounded-[24px] mx-0 my-1 gap-5">
							<!-- Scanning circle -->
							...
							<div class="flex gap-1.5">
								...
								<div class="w-2 h-2 rounded-full bg-[#5CA84A]/40"></div>
								<div class="w-2 h-2 rounded-full bg-[#5CA84A]/20"></div>
							</div>
						</div>
					</div>
				</div>
	...
	<!-- ============================================== -->
	<!-- STORY 02: Confirmed (Phone Left, Text Right) -->
	<!-- ============================================== -->
	...
	<section class="relative w-full bg-[#F3F6F1] overflow-hidden">
		...
		<div class="flex flex-col lg:flex-row items-center w-full max-w-[1400px] mx-auto px-6 md:px-14 lg:px-0 py-20 md:py-28 lg:py-0 lg:min-h-[750px] gap-12 lg:gap-0">
			...
			<!-- Scale + Receipt Mockup -->
			<div class="flex flex-1 items-center justify-center relative lg:py-16">
				<!-- Scale Display Card -->
				<div class="animate-on-scroll" style="transition-delay: 150ms;">
					<div class="flex flex-col items-center w-[260px] md:w-[280px] bg-white rounded-2xl border-2 border-[#E8EDE6] shadow-[0_40px_80px_rgba(26,46,22,0.15)] py-8 px-6 gap-4">
						<!-- Connected badge -->
				...
				<!-- Bluetooth signal lines - decorative -->
				<div class="hidden lg:flex absolute top-32 left-20 flex-col gap-1 opacity-30" aria-hidden="true">
					<div class="w-10 h-px bg-[#3D7D2C]"></div>
					<div class="w-7 h-px bg-[#3D7D2C]"></div>
					<div class="w-4 h-px bg-[#3D7D2C]"></div>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="relative w-full bg-[#1A2E16] overflow-hidden py-20 md:py-28">
		<div class="flex flex-col items-center w-full max-w-[1400px] mx-auto px-6 md:px-14 gap-14">
			...
			<!-- Flow Diagram -->
			<div class="flex flex-col md:flex-row items-center gap-6 md:gap-0 justify-center w-full animate-on-scroll" style="transition-delay: 200ms;">
				<!-- Step 1: Face App -->
				...
				<!-- Arrow -->
				<div class="flex items-center w-16 justify-center rotate-90 md:rotate-0">
					<div class="w-10 h-px bg-[#5CA84A]/40"></div>
					<div class="w-0 h-0 border-t-[4px] border-t-transparent border-b-[4px] border-b-transparent border-l-[6px] border-l-[#5CA84A]/40"></div>
				</div>
	...
	<!-- CTA Block -->
	<!-- ========= -->
	<section class="flex flex-col items-center w-full py-24 md:py-28 px-4 md:px-30 gap-6 bg-[#0A0A0A]">
		<img src="/gardensuite-icon-white.svg" alt="" class="h-12 w-auto mb-2 opacity-90" aria-hidden="true" width="48" height="48" />
		<h2 class="text-[32px] md:text-[40px] text-center tracking-[-0.02em] leading-[1.15] text-white font-['Plus_Jakarta_Sans',system-ui,sans-serif] font-extrabold text-pretty">
			Ready to modernize your tea garden?
		</h2>
		<p class="text-[15px] text-center leading-[1.6] max-w-[500px] text-[#A3A3A3] font-['Inter',system-ui,sans-serif]">
		...
		<div class="flex pt-4 gap-4">
			<a href="/#demo" class="flex items-center justify-center rounded-[100px] py-3.5 px-8 bg-[#1B5E3B] hover:bg-[#144723] transition-colors focus-visible:ring-2 focus-visible:ring-[#5CA84A] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A]" aria-label="Book a Demo">
				<span class="inline-block text-white font-['Inter',system-ui,sans-serif] font-semibold text-sm">
					Book a Demo
				</span>
			</a>
			<a href="/#contact" class="flex items-center justify-center rounded-[100px] py-3.5 px-8 border border-[#333333] hover:bg-[#1A1A1A] transition-colors focus-visible:ring-2 focus-visible:ring-[#5CA84A] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0A0A0A]" aria-label="Contact Us">
				<span class="inline-block text-white font-['Inter',system-ui,sans-serif] font-semibold text-sm">
					Contact Us
				</span>
			</a>
