...
- **Emphasis Serif**: A high-contrast, elegant serif (likely **Newsreader** or **Instrument Serif**) used in _italics_ for specific words within headings to add character (e.g., "the CRM that _works_ for your team").
- **Heading Hierarchy**:
