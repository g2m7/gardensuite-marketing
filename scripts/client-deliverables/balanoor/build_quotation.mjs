...
const outDir = path.join(repoRoot, "deliverables", "balanoor-demo-enquiry-20260714");
const outFile = path.join(outDir, "GardenSuite_Balanoor_Budgetary_Quotation.xlsx");
