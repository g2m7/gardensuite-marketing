...
HTML_FILE = ROOT / "collateral" / "brochures" / "attendance-cheatsheet" / "index.html"
OUT_PDF = ROOT / "deliverables" / "brochures" / "GardenSuite_Attendance_Cheatsheet.pdf"
STATIC_PDF = ROOT / "gs_landing" / "static" / "brochures" / "GardenSuite_Attendance_Cheatsheet.pdf"
PREVIEW_DIR = ROOT / "scratch" / "attendance_cheatsheet_preview"

OUT_PDF.parent.mkdir(parents=True, exist_ok=True)
STATIC_PDF.parent.mkdir(parents=True, exist_ok=True)
PREVIEW_DIR.mkdir(parents=True, exist_ok=True)

print("Exporting cheatsheet from:", HTML_FILE)
