...
All 20 components captured (desktop + mobile) in `/assets/references/tailark/`. Below is the mapping of each reference to a GardenSuite landing page section, with reasoning.
...
All screenshots in `/assets/references/tailark/`:
