...
ROOT = Path(r"C:\projects\biz\gardensuite.in")
OUT = ROOT / "output" / "pdf" / "GardenSuite_Face_Attendance_Smart_Weighing_Brochure.pdf"
PREVIEW = ROOT / "tmp" / "pdfs" / "balanoor-brochure"
...
hero = Image(str(ROOT / "sales_flyer" / "hero-smart-scale.png"), width=176 * mm, height=78 * mm)
