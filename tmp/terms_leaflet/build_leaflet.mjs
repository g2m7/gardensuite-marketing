...
const root = 'C:/projects/biz/gardensuite.in';
const dataPath = path.join(root, 'tmp/terms_leaflet/terms-values.json');
const outputDir = path.join(root, 'output/terms_leaflet');
