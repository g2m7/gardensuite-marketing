# DEPRECATED - GardenSuite Outreach Restart Plan

> [!CAUTION]
> Status: DEPRECATED. This pilot plan does not describe the current lead structure or outreach strategy. Do not resume its WhatsApp queue or Brevo workflow. Read `marketing/outreach/CURRENT_STRATEGY.md`.

Historical status: This plan was pilot-ready after owner review. It is no longer approved for use.
