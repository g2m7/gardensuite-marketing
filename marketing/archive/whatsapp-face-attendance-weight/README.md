# DEPRECATED - GardenSuite WhatsApp Campaign Pack

> [!CAUTION]
> Status: DEPRECATED. This campaign pack is historical and is not approved for current sending. Read `marketing/outreach/CURRENT_STRATEGY.md`.
...
The image creative uses existing graphics from:

- `marketing/email-campaigns/bcp-member-outreach/step1-face-scan.png`
- `marketing/email-campaigns/bcp-member-outreach/step2-weight-capture.png`
