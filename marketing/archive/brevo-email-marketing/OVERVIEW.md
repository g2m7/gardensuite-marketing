# DEPRECATED - Email Marketing Overview

> [!CAUTION]
> Status: DEPRECATED. This describes a retired brochure-to-Brevo nurture workflow. Do not use it to diagnose current outreach or campaign readiness. Read `marketing/outreach/CURRENT_STRATEGY.md`.
...
| File                          | Purpose                                    |
| ----------------------------- | ------------------------------------------ |
| `OVERVIEW.md`                 | Historical strategy record                 |
